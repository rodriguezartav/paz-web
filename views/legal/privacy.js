        ...
        <div className="md:max-w-3xl mx-auto">
          ...
          <p className="mb-10 pb-10 text-base md:text-lg text-coolGray-500 border-b border-coolGray-100">
            <span>
              ...
              consequat ut. Cras pulvinar, lorem tristique pharetra finibus, dui
              erat finibus orci, a vehicula arcu sapien id metus. Quisque quis
              lorem a sem porttitor feugiat. Etiam quis congue est. Donec
