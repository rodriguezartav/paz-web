...
export default function Example() {
  return (
    <Popover className="relative text-white bg-gradient-to-r from-violet-500 to-pink-200 border-b-2 border-white">
      <div className="flex justify-between items-center px-4   sm:px-6 md:justify-start md:space-x-10">
        ...
        <div className="-mr-2 -my-2 md:hidden">
          <Popover.Button className=" rounded-md p-2 inline-flex items-center justify-center text-white hover:text-white0 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
        ...
        <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
          <Popover.Group as="nav" className="flex space-x-10">
                ...
                <>
                  <Popover.Button
                    className={classNames(
                      open ? "text-white" : "text-white0",
                      "group  bg-white rounded-md inline-flex items-center text-base font-medium hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                    )}
                  >
                    <span>Solutions</span>
                    <ChevronDownIcon
                      className={classNames(
                        ...
                        "ml-2 h-5 w-5 group-hover:text-white0"
                      )}
                      aria-hidden="true"
                    />
                  </Popover.Button>
                  ...
                  >
                    <Popover.Panel className="absolute bg-white z-10 -ml-4 mt-3 transform w-screen max-w-md lg:max-w-3xl">
            ...
            <a
              href="#"
              className="text-base font-medium text-white0 hover:text-white"
            >
              Pricing
            </a>
            <a
