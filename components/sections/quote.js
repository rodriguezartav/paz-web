    ...
    <section>
      <div className="pb-20  radius-for-skewed">
        <div className="container mx-auto px-4">
          <div className="max-w-8xl p-4 flex flex-wrap justify-center items-center">
            ...
            <div className="w-full lg:w-2/3">
              <svg
                className="mb-4 text-indigo-600 h-10"
                viewBox="0 0 32 28"
                fill="none"
              ...
              <h3 className="mb-6 dm text-indigo-500 text-3xl lg:text-4xl font-bold font-heading">
                {quote}
              </h3>
            </div>
          </div>
