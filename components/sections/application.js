    ...
    >
      <div className="container px-4 mx-auto">
        <div className="md:max-w-4xl mx-auto mb-16 md:mb-20 text-center">
          ...
          <h1
            className={`mb-4 text-3xl md:text-4xl leading-tight text-coolGray-900 font-bold tracking-tighter  text-${color}`}
          >
            {title}
          </h1>
        ...
        <div className="flex flex-wrap justify-center -mx-4">
          <div className="w-full md:w-1/2 lg:w-1/3 px-4">
            <div className="h-full p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              <div className="inline-flex h-16 w-16 mb-7 mx-auto items-center justify-center text-white bg-indigo-500 rounded-lg">
                <svg
                  width={24}
                  height={21}
                  viewBox="0 0 24 21"
