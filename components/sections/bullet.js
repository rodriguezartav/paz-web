    ...
    >
      <div className="container px-4 mx-auto">
        <div className="xl:max-w-4xl mb-12 mx-auto text-center">
          ...
          <p className="text-lg md:text-xl text-indigo-500 font-medium">
            {subtitle}
          </p>
        </div>
        <div className="flex flex-wrap -mx-4">
          <div className="w-full lg:w-1/3 px-4 lg:pt-6 mb-8 lg:mb-0">
            <div className="p-8 lg:mb-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              ...
              <p className="text-indigo-500 font-medium">{t1_description}</p>
            </div>
            <div className="p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              ...
              <p className="text-indigo-500 font-medium">{t2_description}</p>
            </div>
          </div>
          ...
          <div className="w-full lg:w-1/3 lg:pt-6 px-4">
            <div className="p-8 lg:mb-6 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              ...
              <p className="text-indigo-500 font-medium">{t3_description}</p>
            </div>
            <div className="p-8 text-center hover:bg-white rounded-md hover:shadow-xl transition duration-200">
              <div className="inline-flex h-16 w-16 mb-6 mx-auto items-center justify-center text-white bg-indigo-500 rounded-lg">
                <svg
              ...
              <p className="text-indigo-500 font-medium">{t4_description}</p>
            </div>
          </div>
        </div>
      </div>
