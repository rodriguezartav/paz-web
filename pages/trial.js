...
const offices = [
  {
    id: 1,
    city: "Ohio",
    address: ["4444 E Enon Rd", "Yellow Springs", "OH", "45387"],
  },
];
          ...
          <div className="py-24 lg:py-32">
            <div className="relative z-10 max-w-7xl mx-auto pl-4 pr-8 sm:px-6 lg:px-8">
              ...
              <p className="mt-6 text-xl text-warm-gray-500 max-w-3xl">
                Mogi is in private beta, however if you use salesforce and
                marketo as your marketing tools we are looking for beta
                candiates. Please get in touch.
              </p>
            </div>
          </div>
        </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3">
                ...
                <div className="py-10 px-6 sm:px-10 lg:col-span-2 xl:p-12">
                  <h3 className="text-lg font-medium text-warm-gray-900">
                    Send us a message ( out of service )
                  </h3>
                  <form
                    action="#"
                    method="POST"
                  ...
                  >
                    ...
                    <div className="sm:col-span-2 sm:flex sm:justify-end">
                      <button
                        disabled="disabled"
                        type="submit"
                        className="mt-2 disabled:bg-gray-200 w-full inline-flex items-center justify-center px-6 py-3 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-teal-500 hover:bg-teal-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-teal-500 sm:w-auto"
                      >
