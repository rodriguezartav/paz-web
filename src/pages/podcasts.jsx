        ...
        <div className="mx-auto mb-8 text-center md:mb-16 md:max-w-5xl">
          <h1 className="mx-auto max-w-4xl font-display text-5xl font-medium tracking-tight text-slate-900 sm:text-7xl">
            ...
            <span className="relative whitespace-nowrap text-blue-600">
              ...
              <span className="relative">to get inspired</span>
            </span>{' '}
            by the love of nature
          </h1>
          <p className="text-coolGray-500 mx-auto mt-3 mb-10 max-w-xl text-lg font-medium md:text-xl">
            Even the cold rock is alive, inside <br />
            in love with mistery and magic of life
            <br />
            even science is art
            <br />
            the art of loving it so much
            <br />
