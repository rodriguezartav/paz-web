...
const navigation = [
  {
    ...
    links: [
      ...
      { title: 'The two realities', href: '/docs/installation' },
      { title: 'The scientist for the soul', href: '/docs/installation' },
      { title: 'The shamanic warrior', href: '/docs/installation' },
    ],
  },
  {
