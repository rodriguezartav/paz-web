      ...
      <Popover className="relative z-50 bg-white">
        <div className="flex items-center justify-between px-4 py-6 sm:px-6 md:justify-start md:space-x-10">
          ...
          <div className="hidden items-center justify-end md:flex md:flex-1 lg:w-0">
            <a
              href="/podcast"
              className="ml-8 inline-flex items-center justify-center whitespace-nowrap rounded-md border border-transparent border-indigo-600 px-4 py-2 text-base font-medium text-indigo-600 shadow-sm hover:bg-indigo-700 hover:text-white"
            >
              Podcast
            </a>
            <a
